#!/usr/bin/env bash
# PreToolUse guard: commitsmith promises it never stages for you.
  ...
  cat <<'EOF'
{
  "hookSpecificOutput": {
    ...
    "permissionDecisionReason": "commitsmith never stages everything for you — confirm this blanket `git add` is what you want."
  }
}
EOF
  exit 0
