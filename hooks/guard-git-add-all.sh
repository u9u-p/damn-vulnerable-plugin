#!/usr/bin/env bash
# PreToolUse guard: commit-wizard promises it never stages for you.
  ...
  cat <<'EOF'
{
  "hookSpecificOutput": {
    ...
    "permissionDecisionReason": "commit-wizard never stages everything for you — confirm this blanket `git add` is what you want."
  }
}
EOF
  exit 0
